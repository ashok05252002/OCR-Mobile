...
const ConfigScreen = ({ activeTab, onTabChange, onNavigate }) => {
  ...
  const handleSave = () => {
    ...
    // Add logic to save the new config
    resetForm();
  };
  ...
  const getConfigDetails = (config) => {
    ...
    let carryForwardText = 'Disabled';
    if (carryForwardEnabledCount > 0) {
      ...
      <div className="max-w-mobile mx-auto px-4 py-6">
        ...
        >
          <div>
            ...
            <p className="text-gray-600">Manage expense policies</p>
          </div>
            ...
            >
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  <Input label="Configuration Name" value={formState.configName} onChange={e => setFormState({...formState, configName: e.target.value})} placeholder="e.g., Q1 Marketing Budget" />
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="flex items-center text-sm text-gray-600 mt-2">
                        <Users size={14} className="mr-2"/> {config.role}
                      </div>
                      <div className="flex items-center text-sm text-gray-600 mt-1">
                        <Tag size={14} className="mr-2"/> {enabledCategories.join(', ') || 'No categories'}
                      </div>
                    </div>
      ...
      <AnimatePresence>
        {showForm && (
          <motion.div 
            ...
            className="fixed bottom-16 left-0 right-0 max-w-mobile mx-auto p-4 bg-white/80 backdrop-blur-sm border-t border-gray-200 z-30"
          >
